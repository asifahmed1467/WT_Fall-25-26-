...
<head>
    ...
    <style>
        ...
        /* ALERT POPUP STYLES */
        #alertOverlay { display: none; position: fixed; z-index: 10001; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.85); }
        .alert-popup-card { background: white; margin: 12% auto; padding: 30px; width: 90%; max-width: 450px; border-radius: 15px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.5); border-top: 10px solid #333; }
        .header-danger { border-top-color: #dc3545; color: #dc3545; }
        .header-warning { border-top-color: #ffc107; color: #856404; }
        .header-info { border-top-color: #17a2b8; color: #0c5460; }
        .header-success { border-top-color: #28a745; color: #155724; }
        .alert-msg { font-size: 18px; margin: 20px 0; color: #333; font-weight: 500; }
        .btn-dismiss { background: #333; color: white; border: none; padding: 10px 40px; border-radius: 5px; cursor: pointer; font-weight: bold; }
    </style>
</head>
<body>
...
<div id="mapModal"><div class="modal-content"><h3>Select Location</h3><div id="map"></div><button type="button" class="btn-red" style="margin-top:15px;" onclick="document.getElementById('mapModal').style.display='none'">Confirm</button></div></div>

<div id="alertOverlay">
    <div id="alertCard" class="alert-popup-card">
        <h2 id="alertTitle">ADMIN BROADCAST</h2>
        <p id="alertMessage" class="alert-msg"></p>
